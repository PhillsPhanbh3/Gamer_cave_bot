    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            return interaction.reply({
                content: `${error_emote} An error occurred while removing the role from the user due to a possible API error or missing "Manage Roles" permission. The developers have been notified.`,
                flags: 64
            });
        }
